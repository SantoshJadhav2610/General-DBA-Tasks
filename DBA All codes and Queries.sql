/*
==================================================================================
I have  develop a project for a "Online Retail Company". 
...
***LOG MAINTENANCE***
===========================
 created additional queries that involve updating, deleting, and maintaining logs of these operations 
...
Here’s how we can create triggers to log INSERT, UPDATE, and DELETE operations 
...
Indexes are crucial for optimizing the performance of our SQL Server database, 
